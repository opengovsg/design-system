...
export const Default: StoryObj<FileUploadRootProps> = {}
...
export const Invalid: StoryObj<FileUploadRootProps> = {
  args: {
    maxFiles: 1,
    value: [MOCK_OGP_LOGO_FILE, MOCK_OGP_LOGO_FILE],
  },
}

export const Disabled: StoryObj<FileUploadRootProps> = {
  args: {
    isDisabled: true,
  },
}

export const DisabledWithFiles: StoryObj<FileUploadRootProps> = {
  args: {
    isDisabled: true,
...
export const DisabledWithSingleFile: StoryObj<FileUploadRootProps> = {
  args: {
    isDisabled: true,
    maxFiles: 1,
    value: [MOCK_OGP_LOGO_FILE],
...
export const Playground: StoryObj<FileUploadRootProps> = {
  args: {
    maxFiles: 2,
  },
  render: (args) => {
    const [value, setValue] = useState<File[]>([MOCK_OGP_LOGO_FILE])
    return (
      <FileUpload
        value={value}
        onFileAccept={({ files }) => setValue(files)}
        {...args}
      />
    )
  },
