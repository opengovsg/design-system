// Replicated from @chakra-ui/anatomy since TS is having trouble resolving the type.
// Source: https://github.com/chakra-ui/chakra-ui/blob/v2/packages/anatomy/src/create-anatomy.ts
